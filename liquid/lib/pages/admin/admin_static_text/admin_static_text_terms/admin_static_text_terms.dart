...
class AdminStaticTextTerms extends StatefulWidget {

  AdminStaticTextTerms({Key key}) : super(key: key);

  @override
  _AdminStaticTextTermsState createState() => _AdminStaticTextTermsState();
}

class _AdminStaticTextTermsState extends State<AdminStaticTextTerms> {
  ...
  void _submitForm() async {
    if (_fbKey.currentState.saveAndValidate()) {
      ...
      updateClause['text'] = _fbKey.currentState.value['terms'];
