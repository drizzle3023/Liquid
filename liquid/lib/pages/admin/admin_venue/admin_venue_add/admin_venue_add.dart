...
class AdminVenueAdd extends StatefulWidget {

  AdminVenueAdd({Key key}) : super(key: key);

  @override
  _AdminVenueAddState createState() => _AdminVenueAddState();
}

class _AdminVenueAddState extends State<AdminVenueAdd> {
                                                      ...
                                                      child: FlatButton(
                                                        ...
                                                        onPressed: () async{
                                                          final result = await Navigator.push(
                                                            context,
                                                            MaterialPageRoute(builder: (context) => AdminMap()),
                                                          );
                                                          if (result != null) {
                                                            setState(() {
                                                              newLocation = result;
                                                    ...
                                                    return InputDecorator(
                                                      ...
                                                      child: FlatButton(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon( _logoImage == null ? Icons.add : Icons.check, color: Colors.white, size: 18,),
                                                        ...
                                                        color: _logoImage == null ? Color(0xfff15a24) : Colors.lightGreen,
                                                      ),
                                                    );
                                                  },
                                                ),
                                                    ...
                                                    return InputDecorator(
                                                      ...
                                                      child: FlatButton(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon( _mainImage == null ? Icons.add : Icons.check, color: Colors.white, size: 18,),
                                                            Text("Click button to select image file", style: TextStyle(color: Colors.white),),
                                                          ],
                                                        ),
                                                        onPressed: (){
                                                        ...
                                                        color: _mainImage == null ? Color(0xfff15a24) : Colors.lightGreen,
                                                      ),
                                                    );
                                                  },
                                                ),
                                                    ...
                                                    return InputDecorator(
                                                      ...
                                                      child: FlatButton(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon( _image1 == null ? Icons.add : Icons.check, color: Colors.white, size: 18,),
                                                            Text("Click button to select image file", style: TextStyle(color: Colors.white),),
                                                          ],
                                                        ),
                                                        onPressed: (){
                                                        ...
                                                        color: _image1 == null ? Color(0xfff15a24) : Colors.lightGreen,
                                                      ),
                                                    );
                                                  },
                                                ),
                                                    ...
                                                    return InputDecorator(
                                                      ...
                                                      child: FlatButton(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon( _image2 == null ? Icons.add : Icons.check, color: Colors.white, size: 18,),
                                                            Text("Click button to select image file", style: TextStyle(color: Colors.white),),
                                                          ],
                                                        ),
                                                        onPressed: (){
                                                        ...
                                                        color: _image2 == null ? Color(0xfff15a24) : Colors.lightGreen,
                                                      ),
                                                    );
                                                  },
                                                ),
                                                    ...
                                                    return InputDecorator(
                                                      ...
                                                      child: FlatButton(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon( _image3 == null ? Icons.add : Icons.check, color: Colors.white, size: 18,),
                                                            Text("Click button to select image file", style: TextStyle(color: Colors.white),),
                                                          ],
                                                        ),
                                                        onPressed: (){
                                                        ...
                                                        color: _image3 == null ? Color(0xfff15a24) : Colors.lightGreen,
                                                      ),
                                                    );
                                                  },
                                                ),
                                                    ...
                                                    return InputDecorator(
                                                      ...
                                                      child: FlatButton(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon( _image4 == null ? Icons.add : Icons.check, color: Colors.white, size: 18,),
                                                            Text("Click button to select image file", style: TextStyle(color: Colors.white),),
                                                          ],
                                                        ),
                                                        onPressed: (){
                                                        ...
                                                        color: _image4 == null ? Color(0xfff15a24) : Colors.lightGreen,
                                                      ),
                                                    );
                                                  },
                                                ),
                                                    ...
                                                    return InputDecorator(
                                                      ...
                                                      child: FlatButton(
                                                        child: Row(
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: <Widget>[
                                                            Icon( _image5 == null ? Icons.add : Icons.check, color: Colors.white, size: 18,),
                                                            Text("Click button to select image file", style: TextStyle(color: Colors.white),),
                                                          ],
                                                        ),
                                                        onPressed: (){
                                                        ...
                                                        color: _image5 == null ? Color(0xfff15a24) : Colors.lightGreen,
                                                      ),
                                                    );
                                                  },
                                                ),
  ...
  void _submitForm() async {
    if (_fbKey.currentState.saveAndValidate()) {
      ...
      updateClause['logoImage'] = logoImageUrl;
      updateClause['mainImage'] = mainImageUrl;
      updateClause['image1'] = image1Url;
      updateClause['image2'] = image2Url;
      updateClause['image3'] = image3Url;
      updateClause['image4'] = image4Url;
      updateClause['image5'] = image5Url;

      if (newLocation != null) {
        updateClause['latitude'] = newLocation.latitude.toString();
        updateClause['longitude'] = newLocation.longitude.toString();
      } else {
        updateClause['latitude'] = "0";
        updateClause['longitude'] = "0";
      }
      ...
      updateClause['isActive'] = true;
      updateClause['venueId'] = newChild.key;
      ...
      Venue newVenu = Venue.fromJson(updateClause);
      newChild.set(newVenu.toJson()).then((val){
        setState(() {
          _isLoading = false;
        });
        Globals.shared.showToast(
            context, "Successfully Add new venue.",
