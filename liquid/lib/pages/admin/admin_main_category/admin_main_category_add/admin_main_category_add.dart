...
class AdminMainCategoryAdd extends StatefulWidget {

  AdminMainCategoryAdd({Key key}) : super(key: key);

  @override
  _AdminMainCategoryAddState createState() => _AdminMainCategoryAddState();
}

class _AdminMainCategoryAddState extends State<AdminMainCategoryAdd> {
    ...
    if (_fbKey.currentState.saveAndValidate()) {
      ...
      newChild.set(updateClause).then((val){
        ...
        Globals.shared.showToast(
            context, "Successfully Add new main category.",
