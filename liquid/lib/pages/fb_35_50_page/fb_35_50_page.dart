...
class FB_35_50Page extends StatefulWidget {
  FB_35_50Page({Key key}) : super(key: key);

  @override
  _FB_35_50PageState createState() => _FB_35_50PageState();
}

class _FB_35_50PageState extends State<FB_35_50Page> {
                      ...
                      if (snap.hasData &&
                        ...
                        snapshot.value.forEach((key, value) {
                          if (key != null && value != null) {
                            ...
                            value["category"] != null &&
                                value["category"]["id"] == 1 &&
                                ((value["discountBeverages"] != null && (int.tryParse(value["discountBeverages"]) ?? 0 ) >= 35 && (int.tryParse(value["discountBeverages"]) ?? 0 ) <= 50) ||
                                    (value["discountFood"] != null && (int.tryParse(value["discountFood"]) ?? 0 ) >= 35 && (int.tryParse(value["discountFood"]) ?? 0 ) <= 50))) {
                              item.add(value);
                            }
                          }
                        });
