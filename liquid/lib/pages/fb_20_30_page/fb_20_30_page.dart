...
class FB_20_30Page extends StatefulWidget {
  FB_20_30Page({Key key}) : super(key: key);

  @override
  _FB_20_30PageState createState() => _FB_20_30PageState();
}

class _FB_20_30PageState extends State<FB_20_30Page> {
                      ...
                      if (snap.hasData &&
                        ...
                        snapshot.value.forEach((key, value) {
                          if (key != null && value != null) {
                            ...
                            value["category"] != null &&
                                value["category"]["id"] == 1 &&
                                ((value["discountBeverages"] != null && (int.tryParse(value["discountBeverages"]) ?? 0 ) >= 20 && (int.tryParse(value["discountBeverages"]) ?? 0 ) <= 30) ||
                                    (value["discountFood"] != null && (int.tryParse(value["discountFood"]) ?? 0 ) >= 20 && (int.tryParse(value["discountFood"]) ?? 0 ) <= 30))) {
                              item.add(value);
                            }
                          }
                        });
